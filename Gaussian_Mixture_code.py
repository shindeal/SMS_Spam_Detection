# -*- coding: utf-8 -*-
"""
Created on Mon Nov 21 20:25:48 2022
...
#sms_text_data_df = pd.read_csv("E:\Dessertation\Python_code\Final_code\Dataset_5971 - Copy.csv",encoding= 'unicode_escape')
#sms_text_data_df.value.value_counts()
...
model.fit(X_train_vc.toarray())
clusters = model.predict(X_train_vc.toarray())
...
# sms_text_data_df['ClusterName'] = sms_text_data_df['ClusterName'].map( {1:'ham', 0: 'spam'} )
# sms_text_data_df["ClusterName"].value_counts()
...
def plot_confusion_matrix(y_true, y_pred):
   ...
   plt.title('Guassian Matrix Model Confusion Matrix')
...
model_pre_trained_g = pickle.load(open('model.pkl','rb'))
...
cluster_pred_unseen = model_pre_trained_g.predict(sms_text_unseen)
